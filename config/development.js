...
module.exports = {
  JWTSETTINGS: {
    ...
    accessTokenExpire: '20m', // 20 Min
    refreshTokenExpire: '1y', // 01 Year
    ...
    accessToken_DB_expTime: '1200', // SHOULD ALWAYS BE IN SECONDS
    refreshToken_DB_expireTime: '31536000', // SHOULD ALWAYS BE IN SECONDS
    redisSettings: {
  ...
  CS_Details : {
    login_url : "https://dev-ws1.complx.app/cs/login",
  ...
  WS_ENDPOINT: "wss://dev-ws3.complx.app/customer/",
